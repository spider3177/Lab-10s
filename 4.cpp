...
// Moving point p2 by (1, -1):
  ...
  cout<< "The x value for p2 is " << p2.Get_X() << endl;
  cout<< "The y value for p2 is " << p2.Get_Y() << endl;
//Lab 7 Exercises 4.2, 4.3. 
	int x1,x2,y1,y2;
	rectangle rec1;
	//declaring an object rec1 of class rectangle
	cout<<"point of the default rectangle is";rec1.print();
	cout<<endl;
	...
	Point a(x1, y1);
	Point b(x2, y2);
	//declaring two points for the rectangle
	rectangle rec2(a,b);
	//rectangle taking two points as input
	rec2.print();
	//calling of function of rectangle
	cout<<"Area of the rectangle is "<<rec2.area()<<endl;
	//calling area function from class rectangle
return 0;
}
